...
import { HTTP_HEADER, ERR_SC, currentObj as api } from '../../../../../lib-common/service-api/3nstorage/owner';
...
accessDiffedObjVersion.definition = (setup: () => TestSetup) => (() => {
	...
	beforeAllAsync(async () => {
		...
		await saveObj(user.storageOwnerUrl, sessionId, false, diffVer.objId, diffVer.version, diffVer);
		reqOpts = {
